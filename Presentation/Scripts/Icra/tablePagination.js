function initIcraTablePagination(tableId, pageSizeSelectId, paginationNavId, tableInfoId, searchInputId) {
    // Varsayılan ID'leri tanımla
    tableId = tableId || "icraTable";
    pageSizeSelectId = pageSizeSelectId || "icraPageSize";
    paginationNavId = paginationNavId || "icraPaginationNav";
    tableInfoId = tableInfoId || "icraTableInfo";
    ...
    function renderTable() {
        ...
        // İcra sayfasına özel sayaç elemanlarını güncelle
