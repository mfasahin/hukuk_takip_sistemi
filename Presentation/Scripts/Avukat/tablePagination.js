function initAvukatTablePagination(tableId, pageSizeSelectId, paginationNavId, tableInfoId, searchInputId) {
    // Varsayılan id'leri güvenli şekilde belirle
    tableId = tableId || "avukatTable";
    pageSizeSelectId = pageSizeSelectId || "avukatPageSize";
    paginationNavId = paginationNavId || "avukatPaginationNav";
    tableInfoId = tableInfoId || "avukatTableInfo";
    ...
    function renderTable() {
        ...
        // Avukatlar sayfasına özel sayaç elemanlarını güncelle
    ...
    // 1. ARAMA KUTUSU DİNLEYİCİSİ (Anlık filtreleme tetikler)
